<template>
	<view class="mt-2">
		<huzhu :item="list" class="px-3" @pinglun="changePlStatus()" :comment="commentList.length" :dz="dz"
			:star="star" @dianzan="getCount()"></huzhu>
	...
	export default {
		...
		methods: {
			...
			load(id) {
				...
				getComment(2, id, parma).then(res => {
					console.log(res)
