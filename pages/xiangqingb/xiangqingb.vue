<template>
	<view class="mt-2">
		<ershou :item="list" class="px-3" @pinglun="changePlStatus()" :comment="commentList.length" :dz="dz"
			:star="star" @dianzan="getCount()"></ershou>
	...
	export default {
		...
		methods: {
			...
			load(id) {
				...
				getComment(3, id, parma).then(res => {
					console.log(res)
